    ...
    public static class ExemplarBaseClass
    {
        ...
        public static ClassSelectionFeat CreateExemplarClassFeat()
        {
            ...
            .WithOnSheet(sheet =>
            {
                ...
                sheet.AddSelectionOption(new SingleFeatSelectionOption("ExemplarFeat1", "Exemplar Feat", 1, ft => ft.HasTrait(TExemplar)));
                sheet.AddSelectionOption(new SingleFeatSelectionOption("RootEpithet", "Root Epithet", 3, ft => ft.HasTrait(TExemplar)));
                sheet.AddSelectionOption(new SingleFeatSelectionOption("DominionEpithet", "Dominion Epithet", 7, ft => ft.HasTrait(TExemplar)));
